...
def build_inventory(completion: dict[str, Any]) -> dict[str, Any]:
    critical = [
        ...
        ROOT / "experiments/gate_26_riemensperger_full_completion/manifests/gate26_preflight.json", ROOT / "experiments/gate_26_riemensperger_full_completion/manifests/execution_lock.json",
        ROOT / "experiments/gate_21b_riemensperger_healthy/manifests/healthy_manifest.json", ROOT / "experiments/gate_21b_riemensperger_healthy/metrics/healthy_per_seed_metrics.csv", ROOT / "experiments/gate_21b_riemensperger_healthy/results/healthy_summary.json", ROOT / "experiments/gate_21b_riemensperger_healthy/results/healthy_execution_plan.json",
        ROOT / "experiments/gate_21b_riemensperger_healthy/results/gpu_telemetry.json", ROOT / "experiments/gate_21c_riemensperger_healthy_comparability/manifests/healthy_comparability_manifest.json", ROOT / "experiments/gate_21c_riemensperger_healthy_comparability/results/healthy_comparability_summary.json",
        ROOT / "experiments/gate_21e_riemensperger_disease/checkpoint_materialization/riemensperger_dopamine_checkpoint_manifest.json", ROOT / "experiments/gate_21e_riemensperger_disease/checkpoint_materialization/status.json", ROOT / "experiments/gate_21e_riemensperger_disease/metrics/disease_per_seed_metrics.csv", ROOT / "experiments/gate_21e_riemensperger_disease/results/disease_summary.json", ROOT / "experiments/gate_21e_riemensperger_disease/results/disease_execution_plan.json", ROOT / "experiments/gate_21e_riemensperger_disease/results/gpu_telemetry.json", ROOT / "experiments/gate_21e_riemensperger_disease/manifests/disease_manifest.json",
        ROOT / "experiments/gate_21f_four_group_analysis/manifests/four_group_manifest.json", ROOT / "experiments/gate_21f_four_group_analysis/metrics/four_group_table.csv", ROOT / "experiments/gate_21f_four_group_analysis/results/four_group_summary.json", ROOT / "experiments/gate_21f_four_group_analysis/results/four_group_effect_comparison.csv",
        ROOT / "experiments/gate_21g_riemensperger_robustness/manifests/robustness_manifest.json", ROOT / "experiments/gate_21g_riemensperger_robustness/results/robustness_summary.json",
